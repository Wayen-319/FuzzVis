...
u8 fuzz_one_original(afl_state_t *afl) {
  ...
  u32 a_len = 0;
  FILE *log = fopen("/home/spark/AFLplusplus/tmp/log.txt", "a");
  afl->mutation_history[0] = 0;
#ifdef IGNORE_FINDS
  ...
  if (likely(afl->pending_favored)) {
    ...
    if (afl->queue_cycle > 1 && !afl->queue_cur->fuzz_level) {
      ...
      if (likely(rand_below(afl, 100) < SKIP_NFAV_NEW_PROB)) { fclose(log);
	      return 1; }

    } else {

      if (likely(rand_below(afl, 100) < SKIP_NFAV_OLD_PROB)) { fclose(log);
	      return 1; }
  ...
  if (log) {
    fprintf(log, "\n[SEED] Reading: %s", afl->queue_cur->fname); 
    fprintf(log, "\n[INPUT SEED]:");
    fwrite(orig_in, 1, len, log);
    fflush(log);
  }
...
#define FLIP_BIT(_ar, _b)                     \
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    snprintf((char*)afl->mutation_history + strlen((char*)afl->mutation_history),
         4096 - strlen((char*)afl->mutation_history),
         "flip1-%u;", afl->stage_cur_byte);
...
#endif
    int k = 0;
    const char* arr[] = {                                                                                 "MUT_FLIPBIT", "MUT_FLIPBIT", "MUT_FLIPBIT", "MUT_FLIPBIT", "MUT_FLIPBIT", "MUT_FLIPBIT", "MUT_FLIPBIT",
    "MUT_INTERESTING8", "MUT_INTERESTING8", "MUT_INTERESTING8", "MUT_INTERESTING8", "MUT_INTERESTING8", "MUT_INTERESTING8",
    "MUT_INTERESTING16", "MUT_INTERESTING16", "MUT_INTERESTING16", "MUT_INTERESTING16", "MUT_INTERESTING16", "MUT_INTERESTING16",
    "MUT_INTERESTING16BE", "MUT_INTERESTING16BE", "MUT_INTERESTING16BE", "MUT_INTERESTING16BE", "MUT_INTERESTING16BE", "MUT_INTERESTING16BE",
    "MUT_INTERESTING32", "MUT_INTERESTING32", "MUT_INTERESTING32", "MUT_INTERESTING32", "MUT_INTERESTING32", "MUT_INTERESTING32",
    "MUT_INTERESTING32BE", "MUT_INTERESTING32BE", "MUT_INTERESTING32BE", "MUT_INTERESTING32BE", "MUT_INTERESTING32BE", "MUT_INTERESTING32BE",
    "MUT_ARITH8_", "MUT_ARITH8_", "MUT_ARITH8_", "MUT_ARITH8_", "MUT_ARITH8_", "MUT_ARITH8_", "MUT_ARITH8_",
    "MUT_ARITH8", "MUT_ARITH8", "MUT_ARITH8", "MUT_ARITH8", "MUT_ARITH8", "MUT_ARITH8", "MUT_ARITH8",
    "MUT_ARITH16_", "MUT_ARITH16_", "MUT_ARITH16_", "MUT_ARITH16_", "MUT_ARITH16_", "MUT_ARITH16_",
    "MUT_ARITH16BE_", "MUT_ARITH16BE_", "MUT_ARITH16BE_", "MUT_ARITH16BE_", "MUT_ARITH16BE_", "MUT_ARITH16BE_",
    "MUT_ARITH16", "MUT_ARITH16", "MUT_ARITH16", "MUT_ARITH16", "MUT_ARITH16", "MUT_ARITH16",             "MUT_ARITH16BE", "MUT_ARITH16BE", "MUT_ARITH16BE", "MUT_ARITH16BE", "MUT_ARITH16BE", "MUT_ARITH16BE",                                                                                                       "MUT_ARITH32_", "MUT_ARITH32_", "MUT_ARITH32_", "MUT_ARITH32_", "MUT_ARITH32_", "MUT_ARITH32_",       "MUT_ARITH32BE_", "MUT_ARITH32BE_", "MUT_ARITH32BE_", "MUT_ARITH32BE_", "MUT_ARITH32BE_", "MUT_ARITH32BE_",                                                                                                 "MUT_ARITH32", "MUT_ARITH32", "MUT_ARITH32", "MUT_ARITH32", "MUT_ARITH32", "MUT_ARITH32", "MUT_ARITH32",                                                                                                    "MUT_ARITH32BE", "MUT_ARITH32BE", "MUT_ARITH32BE", "MUT_ARITH32BE", "MUT_ARITH32BE", "MUT_ARITH32BE",                                                                                                       "MUT_RAND8", "MUT_RAND8", "MUT_RAND8", "MUT_RAND8", "MUT_RAND8", "MUT_RAND8",                         "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY",
    "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY", "MUT_CLONE_COPY",
    "MUT_CLONE_FIXED", "MUT_CLONE_FIXED", "MUT_CLONE_FIXED", "MUT_CLONE_FIXED", "MUT_CLONE_FIXED", "MUT_CLONE_FIXED",
    "MUT_CLONE_FIXED", "MUT_CLONE_FIXED", "MUT_CLONE_FIXED",                                              "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY",                                                                         "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY", "MUT_OVERWRITE_COPY",                                     "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED", "MUT_OVERWRITE_FIXED",
    "MUT_BYTEADD", "MUT_BYTEADD", "MUT_BYTEADD", "MUT_BYTEADD", "MUT_BYTEADD", "MUT_BYTEADD", "MUT_BYTEADD",
    "MUT_BYTESUB", "MUT_BYTESUB", "MUT_BYTESUB", "MUT_BYTESUB", "MUT_BYTESUB", "MUT_BYTESUB", "MUT_BYTESUB",
    "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8", "MUT_FLIP8",
    "MUT_SWITCH", "MUT_SWITCH", "MUT_SWITCH", "MUT_SWITCH", "MUT_SWITCH", "MUT_SWITCH", "MUT_SWITCH",
    "MUT_DEL", "MUT_DEL", "MUT_DEL", "MUT_DEL", "MUT_DEL", "MUT_DEL",
    "MUT_SHUFFLE", "MUT_SHUFFLE", "MUT_SHUFFLE", "MUT_SHUFFLE", "MUT_SHUFFLE", "MUT_SHUFFLE",
    "MUT_DELONE", "MUT_DELONE", "MUT_DELONE", "MUT_DELONE", "MUT_DELONE", "MUT_DELONE",
    "MUT_INSERTONE", "MUT_INSERTONE", "MUT_INSERTONE", "MUT_INSERTONE", "MUT_INSERTONE", "MUT_INSERTONE",
    "MUT_ASCIINUM", "MUT_ASCIINUM", "MUT_ASCIINUM", "MUT_ASCIINUM", "MUT_ASCIINUM", "MUT_ASCIINUM",
    "MUT_INSERTASCIINUM", "MUT_INSERTASCIINUM", "MUT_INSERTASCIINUM", "MUT_INSERTASCIINUM", "MUT_INSERTASCIINUM", "MUT_INSERTASCIINUM",
    "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE", "MUT_EXTRA_OVERWRITE",
    "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT", "MUT_EXTRA_INSERT",
    "MUT_AUTO_EXTRA_OVERWRITE", "MUT_AUTO_EXTRA_OVERWRITE", "MUT_AUTO_EXTRA_OVERWRITE", "MUT_AUTO_EXTRA_OVERWRITE", "MUT_AUTO_EXTRA_OVERWRITE", "MUT_AUTO_EXTRA_OVERWRITE",
    "MUT_AUTO_EXTRA_INSERT", "MUT_AUTO_EXTRA_INSERT", "MUT_AUTO_EXTRA_INSERT", "MUT_AUTO_EXTRA_INSERT", "MUT_AUTO_EXTRA_INSERT", "MUT_AUTO_EXTRA_INSERT",
    "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE", "MUT_SPLICE_OVERWRITE",
    "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT", "MUT_SPLICE_INSERT"
};
u32 t = 0; 
    ...
    retry_havoc_step: {
      ...
      switch (mutation_array[r]) {
        ...
        case MUT_INTERESTING8: {
          ...
          strcat(afl->mutation, afl->m_tmp);
#endif
	  t = rand_below(afl, temp_len);
          out_buf[t] = interesting_8[item];
          break;
...
abandon_entry:
  ...
  if (log){
      if(memcmp(in_buf, out_buf, len) == 0){
          fprintf(log, "\n===============ABANDON_ENTRY===============\n");
          fflush(log);	  
      }
      else{
          fprintf(log, "\n[OUTPUT SEED afl-fuzz-one.c]:\n");
	        fwrite(out_buf, 1, len, log);
	        fflush(log);
      }
  }
